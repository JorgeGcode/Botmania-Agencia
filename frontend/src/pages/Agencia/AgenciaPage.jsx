...
const AgenciaPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "IA entrenada para hablar como humano. Sin respuestas roboticas."
    }
  ];
    ...
    <div className="bg-slate-900 min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto lg:mx-0">
                  <div className="flex-1">
                    <Input
                      ...
                      className="h-14 bg-slate-800/50 border-slate-700 text-white placeholder:text-slate-500 focus:border-emerald-500 focus:ring-emerald-500/20"
                      required
                    />
                  </div>
                  <Button
                    type="submit"
                    className="h-14 px-8 bg-emerald-500 hover:bg-emerald-400 text-slate-900 font-bold rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/25"
                  >
                    <span>Unirme</span>
              ...
              <p className="mt-4 text-slate-500 text-sm">
                Se el primero en probar nuestros chatbots con IA.
              </p>
            </div>
            ...
            <div className="relative">
              <div className="relative">
                ...
                <div className="relative rounded-3xl overflow-hidden border border-emerald-500/20 shadow-2xl shadow-emerald-500/10">
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    <div className="flex items-center gap-3 p-4 bg-slate-900/80 backdrop-blur-sm rounded-xl border border-emerald-500/30">
              ...
              {/* Floating elements */}
              <div className="absolute -top-4 -right-4 p-3 bg-slate-800 border border-slate-700 rounded-xl shadow-xl">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group p-8 bg-slate-800/30 hover:bg-slate-800/50 rounded-2xl border border-slate-700/50 hover:border-emerald-500/30 transition-all duration-500"
              >
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-slate-500 text-sm uppercase tracking-wider mb-4">Mientras tanto...</p>
